...
<div align="center">
  <strong>🎮 Được xây dựng với ❤️ cho cộng đồng Minecraft | Built with ❤️ for the Minecraft community 🎮</strong>
  
  <br><br>
  
  **👨‍💻 Created by [@Hoocs151](https://github.com/Hoocs151/) & ChatGPT 🤖 | Được tạo bởi [@Hoocs151](https://github.com/Hoocs151/) & ChatGPT 🤖**
  
  <br><br>
  
  *💫 This project is a collaboration between human creativity and AI assistance*  
  *💫 Dự án này là sự hợp tác giữa sáng tạo con người và hỗ trợ AI*
  
  <br>
  
  **⭐ Nếu dự án này hữu ích, hãy cho một star! | If this project is helpful, please give it a star! ⭐**
</div> 